...
var getStylingProps = function getStylingProps(baseClass) {
  ...
  return customStyles[baseClass] && _typeof(customStyles[baseClass]) === 'object'
    ...
    : {
        className: (
          (defaultClasses[baseClass] || baseClass) +
          ' ' +
          (additionalClass || '') +
          ' ' +
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('path', {
          d:
            'M25.9 20.1H41.2C42.1 20.1 42.9 19.4 42.9 18.4V3.1C42.9 2.2 42.1 1.4 41.2 1.4H25.9C24.9 1.4 24.2 2.2 24.2 3.1V18.4C24.2 19.4 25 20.1 25.9 20.1Z',
          stroke: '#424242',
          strokeWidth: '1.122',
          strokeMiterlimit: '10',
        }),
...
var renderCustomActions = function renderCustomActions(_ref2, muteEventHandler, onBlur) {
  ...
  return actions && actions.length
    ? [React.createElement('hr', { key: 'custom-actions-line', className: 'actions-delimiter' })].concat(
      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref5 = ReactDaDataBox.__proto__ || Object.getPrototypeOf(ReactDaDataBox)).call.apply(
              _ref5,
              [this].concat(args)
            )
          )),
...
var _initialiseProps = function _initialiseProps() {
      ...
      _this2.fetchSuggestions(null, function () {
        if (_this2.props.silentInit) {
          ...
          if (
            ...
            forceSelect < _this2.state.suggestions.length
          ) {
  ...
  this.fetchSuggestions = function () {
    var setStateAdditional = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    _this2.xhr.onreadystatechange = function () {
      ...
      if (_this2.xhr.status === 200) {
        ...
        var stateAdditions = setStateAdditional || {};

        if (suggestions && suggestions.length) {
          _this2.setState(
            _extends({}, stateAdditions, {
              suggestions: suggestions,
              suggestionIndex: 0,
              showSuggestions:
                _this2.state.inputFocused || stateAdditions.inputFocused
...
ReactDaDataBox.propTypes = {
  ...
  customEndpoint: _propTypes2.default.oneOfType([
  ...
  payloadModifier: _propTypes2.default.oneOfType([
    _propTypes2.default.object,
    _propTypes2.default.shape,
