    ...
    _this2.xhr.onreadystatechange = function () {
      ...
      if (_this2.xhr.status === 200) {
        ...
        if (suggestions && suggestions.length) {
          _this2.setState(_extends({}, stateAdditions, {
            suggestions: suggestions,
            suggestionIndex: 0,
            showSuggestions: _this2.state.inputFocused || stateAdditions.inputFocused ? Boolean(stateAdditions.showSuggestions) : false
          }), callback);
